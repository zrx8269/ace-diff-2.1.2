(function(root, factory) {
  ...
  function computeDiff(acediff, diffType, offsetLeft, offsetRight, diffText) {
    ...
    if (diffType === C.DIFF_INSERT) {
      ...
      // if the left editor ends with a new line, it also should mark this
      if (lineInfo.leftStartLine === lineInfo.leftEndLine && 
        lineInfo.leftStartLine + 1 === acediff.editors.left.ace.getSession().doc.getAllLines().length &&
        lineInfo.rightStartLine === lineInfo.rightEndLine &&
        lineInfo.rightStartLine + 1 === acediff.editors.right.ace.getSession().doc.getAllLines().length &&
        /^\n/.test(diffText)) {
          lineInfo = {
            leftStartLine: lineInfo.leftStartLine - 1,
            leftEndLine: lineInfo.leftStartLine + 1,
      ...
      // if the right editor ends with a new line, it also should mark this
      if (lineInfo.leftStartLine === lineInfo.leftEndLine && 
        lineInfo.leftStartLine + 1 === acediff.editors.left.ace.getSession().doc.getAllLines().length &&
        lineInfo.rightStartLine === lineInfo.rightEndLine &&
        lineInfo.rightStartLine + 1 === acediff.editors.right.ace.getSession().doc.getAllLines().length &&
  ...
  function getTotalHeight(acediff, editor) {
    ...
    return (ed.ace.getSession().getLength() + 1) * acediff.lineHeight;
  }
